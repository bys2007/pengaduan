 ...
 <body class="bg-[#f5f7fa] min-h-screen flex">
  ...
  <aside class="w-64 bg-white border-r border-gray-200 flex flex-col px-6 py-8 select-none fixed inset-y-0 left-0 z-30" style="background-color: #4B88FE; box-shadow: 0px 0 5px rgba(0, 0, 0, 0.5);">
   ...
   <nav class="flex flex-col space-y-6 text-white text-sm font-normal">
    <a href="dashboard.php" class="flex items-center space-x-2 bg-white text-[#4B88FE] hover:bg-white hover:text-[#4B88FE] rounded-lg px-3 py-2">
   ...
   <section class="bg-white rounded-lg shadow p-6 max-w-3xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8">
        ...
        <div class="md:col-span-2 space-y-5">
          <div>
            <label class="font-semibold text-gray-500 text-sm">ID Petugas</label>
            <p class="text-gray-800 text-lg"><?php echo $row_Radmin['id_petugas']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Nama</label>
            <p class="text-gray-800"><?php echo $row_Radmin['nama_petugas']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Username</label>
            <p class="text-gray-800"><?php echo $row_Radmin['username']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Telepon</label>
            <p class="text-gray-800"><?php echo $row_Radmin['telp']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Level</label>
            <div class="mt-1">
              <span class="bg-gray-600 text-white px-3 py-1 rounded-full text-sm font-semibold"><?php echo ucfirst($row_Radmin['level']); ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6 mt-6 md:mt-0">
          <div>
            ...
            <?php if (!empty($row_Radmin['foto'])): ?>
              <img src="../foto_akun/<?php echo $row_Radmin['foto']; ?>" alt="Foto Profil" class="mt-2 w-full rounded-lg border clickable-image cursor-pointer" />
            <?php else: ?>
          ...
          <div class="mt-8 border-t pt-4 text-right">
            <button id="showPasswordBtn" 
                    data-password="<?php echo $row_Radmin['password']; ?>" 
