      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8">
        ...
        <div class="md:col-span-2 space-y-5">
          <div>
            ...
            <p class="text-gray-800 text-lg"><?php echo $row_Rpetugas['id_petugas']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Nama</label>
            <p class="text-gray-800"><?php echo $row_Rpetugas['nama_petugas']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Username</label>
            <p class="text-gray-800"><?php echo $row_Rpetugas['username']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Telepon</label>
            <p class="text-gray-800"><?php echo $row_Rpetugas['telp']; ?></p>
          </div>
          <div>
            <label class="font-semibold text-gray-500 text-sm">Level</label>
            <div class="mt-1">
              <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold"><?php echo ucfirst($row_Rpetugas['level']); ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6 mt-6 md:mt-0">
          <div>
            ...
            <?php if (!empty($row_Rpetugas['foto'])): ?>
              <img src="../foto_akun/<?php echo $row_Rpetugas['foto']; ?>" alt="Foto Profil" class="mt-2 w-full rounded-lg border clickable-image cursor-pointer" />
            <?php else: ?>
          ...
          <div class="mt-8 border-t pt-4 text-right">
            <button id="showPasswordBtn" 
                    data-password="<?php echo $row_Rpetugas['password']; ?>" 
