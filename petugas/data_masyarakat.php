      ...
      <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden shadow-sm">
        <thead class="bg-[#4B88FE]">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Username</th>
            <th class="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Password</th>
            <th class="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">No Telepon</th>
            <th class="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Foto Profil</th>
          </tr>
        </thead>
        <tbody class="bg-white divide-y divide-gray-100">
          <?php do { ?>
          <tr class="hover:bg-gray-50 transition">
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo $row_Rmasyarakat['nik']; ?></td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo $row_Rmasyarakat['nama']; ?></td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo $row_Rmasyarakat['username']; ?></td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo $row_Rmasyarakat['password']; ?></td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo $row_Rmasyarakat['telp']; ?></td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><img src="../foto_akun/<?php echo $row_Rmasyarakat['foto']; ?>" alt="Foto Profil" class="w-10 h-10 rounded-full clickable-image cursor-pointer"/></td>
          </tr>
